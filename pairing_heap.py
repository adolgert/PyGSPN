#!/usr/bin/python
# This code is from python.org's sandbox for collections.
# http://svn.python.org/projects/sandbox/trunk/collections/pairing_heap.py
# It is a copy, completely not written by me.
"""
